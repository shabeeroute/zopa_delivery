        ...
        <div class="card mb-0">
            <div class="card-body">
                 <div class="row align-items-center">
                     <div class="col-md-6">
                         <div class="mb-3">
                             <h5 class="card-title">Warehouse List <span class="text-muted fw-normal ms-2">({{ $branches->count() }})</span></h5>
                         </div>
                     </div>
                     ...
                     <div class="col-md-6">
                         <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                             ...
                             {{-- <div>
                                 <a href="{{ route('seller.branches.create') }}" class="btn btn-light"><i class="bx bx-plus me-1"></i> Add New Warehouse</a>
                             </div> --}}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{-- <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><a class="dropdown-item" href="{{ route('seller.branches.edit',encrypt($branch->id))}}"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i> Edit</a></li>
                                                ...
                                                <form id="form_delete_{{ $loop->iteration }}" method="POST" action="{{ route('seller.branches.destroy',encrypt($branch->id))}}">
                                                    @csrf
                                                    <input type="hidden" name="_method" value="DELETE" />
                                                </form>
                                                <li><a class="dropdown-item" href="{{ route('seller.branches.changeStatus',encrypt($branch->id))}}"><i class="mdi mdi-cursor-pointer font-size-16 text-success me-1"></i> {{ $branch->status?'Deactivate':'Activate'}}</a></li>
                                            </ul>
                                        </div> --}}
