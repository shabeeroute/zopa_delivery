...
@section('title') @lang('translation.Tickets') @endsection
@section('css')
                         ...
                         <tbody>
                            @foreach ($tickets as $ticket)
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            <a href="{{ route('branch.tickets.show',encrypt($ticket->id))}}" class="dropdown-item"><i class="mdi mdi-eye font-size-16 text-success me-1"></i> View</a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
