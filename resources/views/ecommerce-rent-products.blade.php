...
@slot('title')Rent Products @endslot
@endcomponent
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-end mt-4">
                            <div>
                                ...
                                <h5 class="my-0"><span class="text-muted me-2"><del>$500</del></span> <b>$450</b><small>/month</small></h5>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-end mt-4">
                            <div>
                                ...
                                <h5 class="my-0"><span class="text-muted me-2"><del>$240</del></span> <b>$225</b><small>/month</small></h5>
                            </div>
                            <p class="text-muted mb-0">
                                <i class="bx bxs-star text-warning"></i>
                                <i class="bx bxs-star text-warning"></i>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-end mt-4">
                            <div>
                                ...
                                <h5 class="my-0"><span class="text-muted me-2"><del>$175</del></span> <b>$152</b><small>/month</small></h5>
                            </div>
                            <p class="text-muted mb-0">
                                <i class="bx bxs-star text-warning"></i>
                                <i class="bx bxs-star text-warning"></i>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-end mt-4">
                            <div>
                                ...
                                <h5 class="my-0"><span class="text-muted me-2"><del>$150</del></span> <b>$145</b><small>/month</small></h5>
                            </div>
                            <p class="text-muted mb-0">
                                <i class="bx bxs-star text-warning"></i>
                                <i class="bx bxs-star text-warning"></i>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-end mt-4">
                            <div>
                                <h5 class="mb-3 text-truncate"><a href="javascript: void(0);" class="text-dark">Half sleeve T-Shirt</a></h5>
                                <h5 class="my-0"><span class="text-muted me-2"><del>$145</del></span> <b>$138</b><small>/month</small></h5>
                            </div>
                            <p class="text-muted mb-0">
                                <i class="bx bxs-star text-warning"></i>
                                <i class="bx bxs-star text-warning"></i>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-end mt-4">
                            <div>
                                ...
                                <h5 class="my-0"><span class="text-muted me-2"><del>$138</del></span> <b>$135</b><small>/month</small></h5>
                            </div>
