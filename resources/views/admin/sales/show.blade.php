                                    ...
                                    <tbody>
                                        @foreach ($sale_batch->product_items as $product_item)
                                            <tr>
                                                ...
                                                {{-- <td>
                                                    <a class="text-primary" href="{{ $product_item->is_customer? route('admin.customers.view',encrypt($product_item->customer->id)) : route('admin.branches.view',encrypt($product_item->branch->id)) }}" target="_blank">
                                                        {{ $product_item->is_customer? $product_item->customer->name : $product_item->branch->name }}
                                                    </a>
                                                </td> --}}
                                            </tr>
                                        @endforeach
