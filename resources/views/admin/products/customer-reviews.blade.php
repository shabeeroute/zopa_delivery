                        ...
                        <tbody>
                            @foreach ($reviews as $review)
                                <tr>
                                    ...
                                    <td>
                                        <p><a href="{{ route('admin.products.reviews.changeStatus',encrypt($review->id))}}" class="dropdown-item"><i class="mdi mdi-cursor-pointer font-size-16 text-success me-1"></i> {{ $review->status?'Deactivate':'Activate'}}</a></p>
