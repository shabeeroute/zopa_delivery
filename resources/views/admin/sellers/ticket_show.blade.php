...
@slot('li_2') <a href="{{ route('admin.sellers.tickets.index') }}">@lang('translation.Tickets') </a>@endslot
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        <div class="flex-shrink-0 me-3">
                            @if(!empty($ticket->seller->image))
                                <img src="{{ URL::asset('storage/sellers/' . $ticket->seller->image) }}" alt="" class="rounded-circle avatar-sm">
                            @else
                        ...
                        <div class="flex-grow-1">
                            <h5 class="font-size-14 mb-0">{{ $ticket->seller->name }}</h5>
                    ...
                    @foreach ($ticket->replies as $reply)
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="font-size-14 mb-0">{{ $reply->user_id ? ucfirst(auth()->user()->name) :  $ticket->seller->name}}</h5>
...
<div class="modal fade" id="composemodal" tabindex="-1" role="dialog" aria-labelledby="composemodalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <form method="POST" action="{{ route('admin.sellers.tickets.reply.store')  }}">
                @csrf
