...
@section('title') @lang('translation.Customer_Tickets')@endsection
@section('css')
...
@slot('title') @lang('translation.Customer_Tickets') @endslot
@endcomponent
<div class="row">
    <div class="col-lg-12">
        <div class="card mb-0">
            <div class="card-body">
                 <div class="row align-items-center">
                     <div class="col-md-6">
                         <div class="mb-3">
                             <h5 class="card-title">Tickets List @isset($customer) of {{ $customer->name }} @endisset <span class="text-muted fw-normal ms-2">({{ $tickets->count() }})</span></h5>
                         </div>
                     </div>
                         ...
                         <tbody>
                            @foreach ($tickets as $ticket)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.customers.view',encrypt($ticket->customer->id))}}" target="_blank" class="text-primary">{{ $ticket->customer->name }}</a>
                                    </td>
                                    <td>{{ $ticket->title }}</td>
