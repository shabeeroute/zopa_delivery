                         ...
                         <tbody>
                             @foreach ($orders as $order)
                                ...
                                <tr>
                                    ...
                                    {{-- <td>
                                        <a class="text-primary"  href="#{{ route('admin.customers.view',encrypt($product_item->branch->customer->id))}}" target="_blank">{{ $product_item->branch->customer->name }}, {{ $product_item->branch->customer->city }}</a>
                                    </td> --}}
                                    <td>
