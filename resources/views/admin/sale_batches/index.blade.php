                        ...
                        <thead class="table-light">
                         ...
                         <tbody>
                             ...
                             <tr>
                                ...
                                <td><a href="#" class="text-body">{{ $sale_batch->product_items->count() }} item</a></td>
                                <td>{{ $sale_batch->created_at->format('d F, Y') }}</td>
                                <td><a href="{{ route('admin.customers.view',encrypt($sale_batch->sale->customer->id))}}" target="_blank">{{ $sale_batch->sale->customer->name }}</a></td>
                                <td>
                                ...
                                <td>
                                    <a href="{{ route('admin.orders.show', encrypt($sale_batch->id)) }}" class="btn btn-primary btn-sm btn-rounded" >
                                        View Details
                                    </a>
                                </td>
                                {{-- <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            @foreach ( Utility::saleStatus() as $index => $sale_status )
                                                @if ($index!=0)
                                                    <li><a href="{{ route('admin.sales.changeStatus',['id'=>encrypt($sale_batch->id),'status'=>encrypt($index)])}}" class="dropdown-item">{{ $sale_status['name'] }}</a></li>
                                                @endif
                                            @endforeach
                                    </ul>
                                    </div>
