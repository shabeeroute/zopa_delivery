                                    ...
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <p class="text-muted mb-0">Already have an account ? <a href=""
                                                    {{-- {{ route('login') }} --}}
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control" id="basicpill-firstname-input" placeholder="Enter Your First Name" id="first_name" name="first_name">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control"  placeholder="Enter Your Phone No." id="phone_number" name="phone_number">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            <label for="basicpill-email-input" class="form-label">Email</label>
                                                                            <input type="text" class="form-control" placeholder="Enter Your Email ID" id="email_id" name="email_id">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            <label for="basicpill-address-input" class="form-label">Password</label>
                                                        ...
                                                        <div class="tab-pane" id="company-document">
                                                            ...
                                                            <div class="text-center mb-4">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            <label for="basicpill-pancard-input" class="form-label">Leagal Name</label>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            <label for="basicpill-vatno-input" class="form-label">Business Email</label>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            <label for="basicpill-cstno-input" class="form-label">VAT/TIN No.</label>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            <label for="basicpill-servicetax-input" class="form-label">VAT Certificate </label>
                                                                            <input type="file" class="form-control form-control-lg form-control-solid" name="vat_scan" id="vat_scan" onchange="previewfile(this)"/>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            <label for="basicpill-cstno-input" class="form-label">CR Number</label>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            <label for="basicpill-servicetax-input" class="form-label">CR Scan</label>
                                                                            <input type="file" class="form-control form-control-lg form-control-solid" name="cr_scan" id="cr_scan" onchange="previewfile(this)"/>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <div class="mb-3">
                                                                            <label for="basicpill-cstno-input" class="form-label">Logo</label>
                                                                            <input type="file" class="form-control form-control-lg form-control-solid" name="seller_logo" id="seller_logo" onchange="previewfile(this)"/>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div>
                                                                <div class="text-center mb-4">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <div class="mb-3">
                                                                                <label for="basicpill-namecard-input" class="form-label">Bank Name</label>
                                                                                <select class="form-select" id="bank_name_id" name="bank_name_id">
                                                                                    <option selected>Select Bank Details</option>
                                                                                    @foreach ($bank_lists as $bank_list)
                                                                                    <option value="{{ $bank_list->id }}">{{ $bank_list->name_en }}</option>
                                                                                    @endforeach
                                                                            </select>
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <input type="text" class="form-control" id="basicpill-namecard-input" placeholder="Branch Name" id="branch_name" name="branch_name">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <div class="mb-3">
                                                                                <label for="basicpill-cardno-input" class="form-label">IBAN </label>
                                                                                <input type="text" class="form-control" id="basicpill-cardno-input" placeholder="IBAN" id="iban_number" name="iban_number">
                                                                            </div>
                                                                        </div>

                                                                        <div class="col-lg-6">
                                                                            <div class="mb-3">
                                                                                <label for="basicpill-card-verification-input" class="form-label">Account Number
                                                                                </label>
