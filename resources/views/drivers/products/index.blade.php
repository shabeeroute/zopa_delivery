                 ...
                 <div class="row align-items-center">
                     ...
                     <div class="col-md-6">
                         <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                             ...
                             <div>
                                 <a href="{{ route('seller.products.create') }}" class="btn btn-light"><i class="bx bx-plus me-1"></i> Add New</a>
                             </div>
                               ...
                               @endif
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><a href="{{ route('seller.products.edit',encrypt($product->id))}}" class="dropdown-item"><i class="mdi mdi-pencil font-size-16 text-success me-1"></i> Edit</a></li>
                                            {{-- <li><a href="{{ route('seller.products.destroy',encrypt($product->id))}}" class="dropdown-item"><i class="mdi mdi-trash-can font-size-16 text-danger me-1"></i> Delete</a></li> --}}
                                            ...
                                            <form id="form_delete_{{ $loop->iteration }}" method="POST" action="{{ route('seller.products.destroy',encrypt($product->id))}}">
                                                @csrf
                                                <input type="hidden" name="_method" value="DELETE" />
                                            </form>
                                            <li><a class="dropdown-item" href="{{ route('seller.products.changeStatus',encrypt($product->id))}}"><i class="mdi mdi-cursor-pointer font-size-16 text-success me-1"></i> {{ $product->status?'Deactivate':'Activate'}}</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
