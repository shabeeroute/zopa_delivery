...
@section('content')
    ...
    <section class="header-content">
        ...
        <div class="owl-slider">
            ...
            <div class="item" style="background-image:url(front/assets/images/gallery-1.jpg)">
                <div class="box">
                    <div class="container">
            ...
            <div class="item" style="background-image:url(front/assets/images/gallery-2.jpg)">
                <div class="box">
                    <div class="container">
            ...
            <div class="item" style="background-image:url(front/assets/images/gallery-3.jpg)">
                <div class="box">
                    <div class="container">
                        ...
                        <div class="figure-grid">
                            <div class="image">
                                <a href="#productid1" class="mfp-open">
                                    <img src="front/assets/images/product-1.png" alt="" width="360" />
                                </a>
                            </div>
                            <div class="text">
                ...
                <div class="col-md-4 col-xs-6">
                    <article>
                        ...
                        <div class="figure-grid">
                            <div class="image">
                                <a href="#productid1" class="mfp-open">
                                    <img src="front/assets/images/product-2.png" alt="" width="360" />
                                </a>
                            </div>
                            <div class="text">
                ...
                <div class="col-md-4 col-xs-6">
                    <article>
                        ...
                        <div class="figure-grid">
                            ...
                            <div class="image">
                                <a href="#productid1" class="mfp-open">
                                    <img src="front/assets/images/product-3.png" alt="" width="360" />
                                </a>
                            </div>
                            <div class="text">
                ...
                <div class="col-md-4 col-xs-6">
                    <article>
                        ...
                        <div class="figure-grid">
                            <div class="image">
                                <a href="#productid1" class="mfp-open">
                                    <img src="front/assets/images/product-4.png" alt="" width="360" />
                                </a>
                            </div>
                            <div class="text">
                ...
                <div class="col-md-4 col-xs-6">
                    <article>
                        ...
                        <div class="figure-grid">
                            ...
                            <div class="image">
                                <a href="#productid1" class="mfp-open">
                                    <img src="front/assets/images/product-5.png" alt="" width="360" />
                                </a>
                            </div>
                            <div class="text">
                ...
                <div class="col-md-4 col-xs-6">
                    <article>
                        ...
                        <div class="figure-grid">
                            <div class="image">
                                <a href="#productid1" class="mfp-open">
                                    <img src="front/assets/images/product-6.png" alt="" width="360" />
                                </a>
                            </div>
                            <div class="text">
            ...
            <div class="popup-main mfp-hide" id="productid1">
                ...
                <div class="product">
                    ...
                    <div class="owl-product-gallery">
                        <img src="front/assets/images/product-1.png" alt="" width="640" />
                        <img src="front/assets/images/product-2.png" alt="" width="640" />
                        <img src="front/assets/images/product-3.png" alt="" width="640" />
                        <img src="front/assets/images/product-4.png" alt="" width="640" />
                    </div>
    ...
    <section class="stretcher-wrapper">
        ...
        <ul class="stretcher">
            ...
            <li class="stretcher-item" style="background-image:url(front/assets/images/gallery-1.jpg);">
                <!--logo-item-->
            ...
            <li class="stretcher-item" style="background-image:url(front/assets/images/gallery-2.jpg);">
                <!--logo-item-->
                <div class="stretcher-logo">
                    <div class="text">
            ...
            <li class="stretcher-item" style="background-image:url(front/assets/images/gallery-3.jpg);">
                <!--logo-item-->
                <div class="stretcher-logo">
                    <div class="text">
            ...
            <li class="stretcher-item" style="background-image:url(front/assets/images/gallery-4.jpg);">
                <!--logo-item-->
                <div class="stretcher-logo">
                    <div class="text">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <article>
                        <a href="article.html">
                            <div class="image">
                                <img src="front/assets/images/project-1.jpg" alt="" />
                            </div>
                ...
                <div class="col-sm-4">
                    <article>
                        <a href="article.html">
                            <div class="image">
                                <img src="front/assets/images/project-2.jpg" alt="" />
                            </div>
                            <div class="entry entry-block">
                ...
                <div class="col-sm-4">
                    <article>
                        <a href="article.html">
                            <div class="image">
                                <img src="front/assets/images/project-3.jpg" alt="" />
                            </div>
                            <div class="entry entry-block">
                                <div class="date">28 Mart 2017</div>
                                <div class="title">
    ...
    <section class="banner" style="background-image:url(front/assets/images/gallery-4.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-md-offset-2 col-md-8 text-center">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <article>
                        <a href="article.html">
                            <div class="image" style="background-image:url(front/assets/images/blog-1.jpg)">
                                <img src="front/assets/images/blog-1.jpg" alt="" />
                            </div>
                ...
                <div class="col-sm-4">
                    <article>
                        <a href="article.html">
                            <div class="image" style="background-image:url(front/assets/images/blog-2.jpg)">
                                <img src="front/assets/images/blog-1.jpg" alt="" />
                            </div>
                            <div class="entry entry-table">
                                <div class="date-wrapper">
                ...
                <div class="col-sm-4">
                    <article>
                        <a href="article.html">
                            <div class="image" style="background-image:url(front/assets/images/blog-8.jpg)">
                                <img src="front/assets/images/blog-8.jpg" alt="" />
                            </div>
                            <div class="entry entry-table">
                                <div class="date-wrapper">
                                    <div class="date">
    ...
    <section class="instagram">
        ...
        <div class="gallery clearfix">
            <a class="item" href="#">
                <img src="front/assets/images/square-1.jpg" alt="Alternate Text" />
            </a>
            <a class="item" href="#">
                <img src="front/assets/images/square-2.jpg" alt="Alternate Text" />
            </a>
            <a class="item" href="#">
                <img src="front/assets/images/square-3.jpg" alt="Alternate Text" />
            </a>
            <a class="item" href="#">
                <img src="front/assets/images/square-4.jpg" alt="Alternate Text" />
            </a>
            <a class="item" href="#">
                <img src="front/assets/images/square-5.jpg" alt="Alternate Text" />
            </a>
            <a class="item" href="#">
                <img src="front/assets/images/square-6.jpg" alt="Alternate Text" />
            </a>
