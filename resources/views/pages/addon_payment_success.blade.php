...
@section('title', 'Addon Purchase Successful - Zopa Food Drop')
                ...
                <div class="card-body">
                    ...
                    @if($payment_method == Utility::PAYMENT_ONLINE)
                        ...
                        <div class="alert alert-success">
                            Payment successful. Your addon plan has been activated, and the addons have been credited to <a href="{{ route('my.wallet') }}"> Wallet</a>.
                        </div>
                    @elseif($payment_method == Utility::PAYMENT_BNK)
                        ...
                        <div class="alert alert-info">
                            ...
                            <p>Once approved by the admin, your addons will be credited to your <a href="{{ route('my.wallet') }}">wallet</a>.</p>
                    ...
                    @if($payment_method == Utility::PAYMENT_ONLINE || $payment_method == Utility::PAYMENT_COD || $payment_method == Utility::PAYMENT_BNK)
                        ...
                        <ul class="list-group mb-3">
                            ...
                            <li class="list-group-item"><strong>Payment Method:</strong> {{ $payment_method == Utility::PAYMENT_ONLINE ? 'Online Payment' : 'Cash on Delivery' }}</li>
                        </ul>
                        <ul class="list-group">
                            @foreach($addons as $addonPivot)
                                @php
