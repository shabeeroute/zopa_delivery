                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="auth-content my-auto">
                                    ...
                                    <div class="user-thumb text-center mb-4 mt-4 pt-2">
                                        <img src="@if (Auth::user()->avatar != ''){{ URL::asset('images/'. Auth::user()->avatar) }}@else{{ URL::asset('assets/images/users/avatar-1.jpg') }}@endif" class="rounded-circle img-thumbnail avatar-lg" alt="thumbnail">
