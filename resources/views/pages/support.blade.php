...
@section('title', 'Support - Zopa Food Drop')
...
<div class="container mt-5">
    ...
    <section class="mb-5">
        ...
        <p>Before reaching out, you may find the answers to your questions in our <a href="{{ route('faq') }}">FAQs section</a>.</p>
    </section>

    <section class="mb-5">
        <h3>Order & Subscription Support</h3>
        <p>If you need help with your order or subscription, visit your <a href="{{ route('customer.profile') }}">Profile</a> page to manage your meals.</p>
    </section>
