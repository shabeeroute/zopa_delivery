    ...
    <div class="card shadow overflow-auto" style="width: 100%; max-width: 400px;">
        <div class="card-body">
                ...
                <div class="mb-3 position-relative">
                    <select id="kitchen_id" name="kitchen_id" class="form-control select2 pe-5">
                        ...
                        <?php $__currentLoopData = $kitchens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kitchen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e(encrypt($kitchen->id)); ?>" <?php echo e((Utility::KITCHEN_KDY == $kitchen->id) ? 'selected' : ''); ?>><?php echo e($kitchen->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
            ...
            <div class="text-center mt-3">
                <small>Already have an account? <a href="<?php echo e(route('index')); ?>">Login</a></small>
            </div>
        </div>
    </div>
</div>
