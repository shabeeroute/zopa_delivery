<?php $__env->startSection('title', 'About Us - Zopa Food Drop'); ?>
...
<div class="container mt-5">
    ...
    <div class="row align-items-center mt-4">
        ...
        <div class="col-md-6 order-md-2 order-1 text-center">
            <img src="<?php echo e(asset('front/images/about_us.jpeg')); ?>" alt="About Zopa Food Drop" class="img-fluid rounded shadow">
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\zopa_delivery\resources\views\pages\about_us.blade.php ENDPATH**/ ?>