...
<form action="<?php echo e($isEdit ? route('admin.meals.update', encrypt($meal->id)) : route('admin.meals.store')); ?>"
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="number" name="quantity" class="form-control" value="<?php echo e(old('quantity', $meal->quantity ?? 0)); ?>">
        </div>
    ...
    <button type="submit" class="btn btn-primary"><?php echo e($isEdit ? 'Update' : 'Create'); ?> Meal</button>
</form>
