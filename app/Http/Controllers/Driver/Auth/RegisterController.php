...
class RegisterController extends Controller
{
    ...
    */
    ...
    {
        $banks=Bank::all();
        return view('drivers.auth.register',compact('banks'));
    }
    ...
    public function store(Request $request)
    {
        ...
        DB::transaction(function () use ($request) {
           ...
           // $detail->image=$seller_logo_name??NULL;
            ...
            $detail->driver_name=$request->driver_name;
        ...
        return redirect()->route('driver.login')->with('success', 'Registration completed successfully');
    }
}
