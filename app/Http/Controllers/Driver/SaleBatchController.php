...
class SaleBatchController extends Controller
{
    ...
    {
        $sale_batches = SaleBatch::where('driver_id',Auth::guard('driver')->id())->orderBy('id')->paginate(Utility::PAGINATE_COUNT);
        // return $sales;
        return view('drivers.sale_batches.index',compact('sale_batches'));
    }
    ...
    public function show($id)
    {
        ...
        return view('drivers.sale_batches.show',compact('sale_batch'));
    }
